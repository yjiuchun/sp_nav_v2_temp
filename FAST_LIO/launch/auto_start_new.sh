...
gnome-terminal -- bash -c "rosbag record --duration=10 /Team_robot_HP /referee_data /referee_info /robot_shoot /robot_state /rotate_state /sentry/cmd_vel /sentry/decision /localization"& sleep 1s
